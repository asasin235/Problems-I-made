...
int main() {
    ...
    while (t--) {
        ...
        // ************************** STRING TC*****************
        // int n = 10000;
        // string sample = "abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        // string consonants = "bcdfghjklmnpqrstvwxyz";
        // string vowels = "aeiouAEIOU";

        // string str = "";
        // for (int i = 0; i < n; i++) {
        //     str += vowels[getRandomFromRange(0, vowels.size() - 1)];
        // }
        // cout << str << endl;
        ...
        // cout << n << endl;
        // for (int i = 0; i < n; i++) {
        //     cout << getRandomFromRange(90000, 100000) << " ";
        // }
        // cout << endl;

        int a = getRandomFromRange(1, 100000000);
        int b = getRandomFromRange(1, 1000000000);
        cout << a << " " << b << endl;
    }
